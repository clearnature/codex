...
pub(crate) static ENTRIES: &[(&str, &str)] = &[
    ...
    ("Bring over supported setup from another coding agent.", "从另一个编码代理迁移受支持的配置。"),
    ("Choose items to import.", "选择要导入的项目。"),
    ("Choose what to import", "选择要导入的内容"),
    ("Codex may add files to your current project folder.", "Codex可能会向当前项目文件夹添加文件。"),
    ...
    ("Unbound ({0})", "未绑定（{0}）"),
    ("Use ", "用 "),
    ("Your existing setup will not be changed.", "你现有的配置不会被修改。"),
